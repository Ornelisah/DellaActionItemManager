...
public class ActionItemManager {
	...
	public static final String[] sortingFactorStrings = {"None", "Creation Date", "Due Date","Assigned Member"};
	...
	//Added for Della05
	private Element currentAssignedMember = null;
	//---------------------------------------------------------------------------------------------------------------------
	...
	public ActionItemManager() {
		...
		// Added for Della05
		//currentAssignedMember=new Element();
	}
	...
	public ActionItem createActionItem(String name, String description,
			...
			String dueDateStr, String selectedMemberName) throws Exception {
		ActionItem ai = new ActionItem(name, description, resolution, status, selectedMemberName);
	...
	public ActionItem updateActionItem(String name, String description,
			String resolution, String status,
			String dueDateStr, 
			int itemIndex, String selectedMemberName)	// Added for Della01
					throws Exception {
	...
	private String getSortFactorText(ActionItem ai, int sortingFactor){
		...
		//Added for Della05
				...
				if (sortingFactor==3)
					if(ai.getSelectedMemberName().length()==0)
						tempFactor = "- No Member Assigned -:";
					else 
						tempFactor = ai.getSelectedMemberName()+":";
		return tempFactor;
	}
	...
	// Added for Della05
	public String getCurrentAssignedMember() {

		return currentActionItem.getSelectedMemberName();
	}

	public int getCurrentAssignedMemberIndex() {
		return memberList.findElement(currentActionItem.getSelectedMemberName());
	}
